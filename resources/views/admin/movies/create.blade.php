                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="rating" value="{{ old('rating') }}" placeholder="e.g., PG-13, R, PG" required
                        ...
                        <div>
                            ...
                            <input type="text" name="duration" value="{{ old('duration') }}" placeholder="e.g., 115 MIN" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="stars" value="{{ old('stars', 5) }}" min="1" max="5" required
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" required
                                  class="w-full bg-black border border-zinc-700 rounded px-4 py-3 text-white font-mono focus:outline-none focus:border-red-500 transition-colors @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs font-mono mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="showtimes" value="{{ old('showtimes') }}" placeholder="e.g., 10:00, 13:00, 16:00, 19:00" required
                    ...
                    <div>
                        ...
                        <input type="text" name="image" value="{{ old('image') }}" placeholder="e.g., images/season1.webp"
                    ...
                    <div>
                        ...
                        <input type="text" name="trailer" value="{{ old('trailer') }}" placeholder="e.g., dQw4w9WgXcQ"
