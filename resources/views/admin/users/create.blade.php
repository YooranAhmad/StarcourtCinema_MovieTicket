            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="text-zinc-400 font-mono text-sm uppercase mb-2 block">Password *</label>
                        ...
                        <div>
                            <label class="text-zinc-400 font-mono text-sm uppercase mb-2 block">Confirm Password *</label>
