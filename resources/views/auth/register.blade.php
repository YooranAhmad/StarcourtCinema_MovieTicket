    ...
    <div class="w-full max-w-md z-10">
        <div class="bg-zinc-900 border-2 border-red-900 p-8 shadow-[0_0_20px_rgba(153,27,27,0.4)] relative">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <!-- Name -->
                 <div>
                    <label for="name" class="block text-zinc-400 uppercase text-[10px] tracking-widest mb-1 ml-1">{{ __('Name') }}</label>
                    ...
                    @if ($errors->has('name'))
                        <p class="text-red-600 text-[10px] uppercase tracking-wider mt-1 ml-1">{{ $errors->first('name') }}</p>
                    @endif
                </div>
                ...
                <!-- Confirm Password -->
                <div class="mt-4">
                    <label for="password_confirmation" class="block text-zinc-400 uppercase text-[10px] tracking-widest mb-1 ml-1">{{ __('Confirm Password') }}</label>
                ...
                <div class="flex flex-col space-y-4 mt-6">
                    ...
                    <a class="text-center text-zinc-500 text-[10px] uppercase tracking-wider hover:text-red-600 transition-colors" href="{{ route('login') }}">
            ...
            <div class="mt-8 pt-6 border-t border-red-950/30 text-center">
                <p class="text-zinc-500 text-[10px] uppercase tracking-wider">
                    Welcome to Hawkins Lab! <a href="{{ route('register') }}" class="text-red-600 hover:text-red-400 underline decoration-red-900 underline-offset-4">Show your ID card</a>
                </p>
            </div>
        </div>
